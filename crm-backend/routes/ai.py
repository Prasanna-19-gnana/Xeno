...
def suggest_segments():
    try:
        ...
        prompt = (
            ...
            "    - 'city_eq' (string, e.g. 'Chennai', 'Kentucky')\n"
            "    - 'inactive_days_gt' (integer)\n"
            "    - 'category_bought' (string, e.g. 'Clothing', 'Footwear', 'Accessories')\n"
            "    - 'age_range' (string, e.g. '18-25', '26-40', '40+')\n"
            "    - 'subscription_status' (string, 'Yes' or 'No')\n"
            "    - 'discount_applied' (string, 'Yes' or 'No')\n"
            "    - 'frequency_of_purchases' (string, e.g. 'Weekly', 'Fortnightly')\n"
            "    - 'season_bought' (string, e.g. 'Winter', 'Spring', 'Summer', 'Fall')\n\n"
...
def campaign_assistant():
    try:
        ...
        system_instruction = (
            ...
            "   - 'rules': segment rule parameters (using total_spend_gt, total_orders_gte, city_eq, inactive_days_gt, category_bought, age_range, subscription_status, discount_applied, frequency_of_purchases, season_bought)\n"
